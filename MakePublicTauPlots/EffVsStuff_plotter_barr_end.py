...
if __name__ == "__main__" :
    ...
    eff_Iso_TGraph = inFile.Get('divide_nvtxProgressionAt'+thr_str+'_noIso_by_nvtx_barrel')
    eff_Iso_TGraph_2 = inFile2.Get('divide_nvtxProgressionAt'+thr_str+'_noIso_by_nvtx_endcap')
