...
if __name__ == "__main__" :
    ...
    inFile2 = ROOT.TFile('/home/llr/cms/mchiusi/Run3preparation/Run3preparation_2023/CMSSW_11_0_2/src/TauObjectsOptimization/PlotTurnOns/ROOTs/ROOTs_2023/efficiencies_of_Run2023_all_eras_unpacked.root')
   ...
   ## from file 1
    ...
    if iso_string:
        ...
        #label = r'$E_{T}^{\tau, L1} > %i$ GeV & Isolation - 2023 Unpacked' % (thr) # 2023B
        label = r'$E_{T}^{\tau, L1} > %i$ GeV & Isolation - 2023 before' % (36)
    else:
        eff_TGraph = inFile2.Get('divide_ptProgressionAt34_noIso_by_pt')
        # label = r'$E_{T}^{\tau, L1} > %i$ GeV - LUT 2023' % (thr)
        # label = r'$E_{T}^{\tau, L1} > %i$ GeV - 2023 Unpacked' % (thr)
        label = r'$E_{T}^{\tau, L1} > %i$ GeV - 2023' % (34)
