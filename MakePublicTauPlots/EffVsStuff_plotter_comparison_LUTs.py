...
if __name__ == "__main__" :
    ...
    eff_Iso_TGraph_2 = inFile.Get('divide_nvtxProgressionAt'+thr_str+'_Iso_by_nvtx')
    ...
    #ax.errorbar(x, y, xerr=x_err, yerr=[y_errD, y_errU], ls='None', label=r'$E_{T}^{\tau, L1} > %i$ GeV - before' % (thr), lw=2, marker='o', color=cmap(0))
    ax.errorbar(x_Iso, y_Iso, xerr=x_err_Iso, yerr=[y_errD_Iso, y_errU_Iso], ls='None', label=r'$E_{T}^{\tau, L1} > %i$ GeV & Isolation - before' % (thr), lw=2, marker='s', color=cmap(0))
    ...
    ## VERSUS NUMBER OF VERTICES
    eff_Iso_TGraph = inFile2.Get('divide_nvtxProgressionAt'+thr_str+'_noIso_by_nvtx')
    ...
    #ax.errorbar(x, y, xerr=x_err, yerr=[y_errD, y_errU], ls='None', label=r'$E_{T}^{\tau, L1} > %i$ GeV - after' % (thr), lw=2, marker='o', color=cmap(2))
    ax.errorbar(x_Iso, y_Iso, xerr=x_err_Iso, yerr=[y_errD_Iso, y_errU_Iso], ls='None', label=r'$E_{T}^{\tau, L1} > %i$ GeV & Isolation - after' % (thr), lw=2, marker='s', color=cmap(1))
    ...
    eff_Iso_TGraph_2 = inFile.Get('divide_etaprogressionAt'+thr_str+'_Iso_by_eta')
