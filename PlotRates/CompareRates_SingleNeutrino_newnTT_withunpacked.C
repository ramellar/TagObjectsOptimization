...
void compare(int run, float targetRate = 14, float calibThr = 1.7) {
  ...
  TFile f_mean("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_SingleNeutrino112XpuReweighted_Run3_MC_optimizationV11_calibThr"+intgr+"p"+decim+".root","READ");
  TFile f_unpacked("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_ZeroBias_Run"+run_str+"_optimizationV11_calibThr"+intgr+"p"+decim+"_unpacked.root","READ");  
  ...
  TString CanvasName = "Comparison_Rate_SingleNeutrino112XpuReweigthed_Run"+run_str+"_newnTT_unpacked_optimizationV11_calibThr"+intgr+"p"+decim;
...
//  rate_NewLayer1_noIso_unpacked->SetLineStyle(2);
  ...
  rate_NewLayer1_Iso_unpacked->SetLineWidth(1);
//  rate_NewLayer1_Iso_unpacked->SetLineStyle(9);
  ...
  rate_NewLayer1_Option24_mean->SetLineColor(kMagenta);
  rate_NewLayer1_Option24_mean->SetLineWidth(1);
  //rate_NewLayer1_Option24_mean->Draw("same");

  rate_NewLayer1_Option26_mean->SetLineColor(kGreen);
  rate_NewLayer1_Option26_mean->SetLineWidth(1);
  //rate_NewLayer1_Option26_mean->Draw("same");

  rate_NewLayer1_Option28_mean->SetLineColor(kYellow);
  rate_NewLayer1_Option28_mean->SetLineWidth(1);
  //rate_NewLayer1_Option28_mean->Draw("same");

  rate_NewLayer1_Option31_mean->SetLineColor(kGreen-5);
  rate_NewLayer1_Option31_mean->SetLineWidth(1);
  //rate_NewLayer1_Option31_mean->Draw("same");

  rate_NewLayer1_Option31_extrap_mean->SetLineColor(kOrange);
  ...
  rate_NewLayer1_noIso_mean->SetLineStyle(2);
  rate_NewLayer1_noIso_mean->SetLineColor(kBlack);
  ...
  */
  ...
  leg->AddEntry(rate_NewLayer1_Option24_mean,"Di-#tau iso (Option 24), reemulated (new nTT)","L");
  leg->AddEntry(rate_NewLayer1_Option26_mean,"Di-#tau iso (Option 26), reemulated (new nTT)","L");
  leg->AddEntry(rate_NewLayer1_Option28_mean,"Di-#tau iso (Option 28), reemulated (new nTT)","L");
 ...
 //
  ...
  ratioPlot31extrap_mean->SetLineColor(kOrange);
  ratioPlot31extrap_mean->SetLineWidth(1);
  ratioPlot31extrap_mean->Draw();

  TH1F* ratioPlot31_mean = (TH1F*)rate_NewLayer1_Option31_mean->Clone("ratioPlot");
  ratioPlot31_mean->Divide(rate_NewLayer1_noIso_mean);
  ratioPlot31_mean->SetLineColor(kGreen-5);
  ratioPlot31_mean->SetLineWidth(1);
  ratioPlot31_mean->Draw("same");

  TH1F* ratioPlot22_mean = (TH1F*)rate_NewLayer1_Option22_mean->Clone("ratioPlot");
  ratioPlot22_mean->Divide(rate_NewLayer1_noIso_mean);
  ratioPlot22_mean->SetLineColor(kBlue);
  ratioPlot22_mean->SetLineWidth(1);
  ratioPlot22_mean->Draw("same");

  TH1F* ratioPlot24_mean = (TH1F*)rate_NewLayer1_Option24_mean->Clone("ratioPlot");
  ratioPlot24_mean->Divide(rate_NewLayer1_noIso_mean);
  ratioPlot24_mean->SetLineColor(kMagenta);
  ratioPlot24_mean->SetLineWidth(1);
  ratioPlot24_mean->Draw("same");

  TH1F* ratioPlot26_mean = (TH1F*)rate_NewLayer1_Option26_mean->Clone("ratioPlot");
  ratioPlot26_mean->Divide(rate_NewLayer1_noIso_mean);
  ratioPlot26_mean->SetLineColor(kGreen);
  ratioPlot26_mean->SetLineWidth(1);
  ratioPlot26_mean->Draw("same");

  TH1F* ratioPlot28_mean = (TH1F*)rate_NewLayer1_Option28_mean->Clone("ratioPlot");
  ratioPlot28_mean->Divide(rate_NewLayer1_noIso_mean);
  ratioPlot28_mean->SetLineColor(kYellow);
  ratioPlot28_mean->SetLineWidth(1);
  ratioPlot28_mean->Draw("same");
