...
void compare(TString tag="effMin0p0", TString opt="0", float targetRate = 14, int run=323755, TString nuGlobalTag = "112X", bool Run3reweight = true, float calibThr = 1.7) {
    ...
    TFile* f_mean;
    if(nuGlobalTag!="0") f_mean = new TFile("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_SingleNeutrino"+nuGlobalTag+isPUReweighted+"_Run3_MC_optimizationV9gs_calibThr"+intgr+"p"+decim+"_"+tag+".root","READ");
    else                 f_mean = new TFile("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_ZeroBias_Run"+run_str+"_optimizationV9_calibThr"+intgr+"p"+decim+".root","READ");
    TFile* f_unpacked = new TFile("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_ZeroBias_Run"+run_str+"_optimizationV9_calibThr"+intgr+"p"+decim+"_unpacked.root","READ");
...
/*    TString CanvasName = "";
    if(nuGlobalTag!="0") CanvasName = "Comparison_Rate_SingleNeutrino"+nuGlobalTag+isPUReweighted+"_Run"+run_str+"_newnTT_unpacked_optimizationV9gs_calibThr"+intgr+"p"+decim+"_"+tag+"_"+opt;
    else                 CanvasName = "Comparison_Rate_Run"+run_str+"_newnTT_unpacked_optimizationV9gs_calibThr"+intgr+"p"+decim+"_"+tag+"_"+opt;
    ...
    TString PDFs = "PDFs/optimizationV9";
    TString ROOTs = "ROOTs/";
