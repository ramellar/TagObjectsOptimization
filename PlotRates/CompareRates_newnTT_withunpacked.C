...
//  rate_NewLayer1_Iso_unpacked->SetLineStyle(9);
  ...
  leg->AddEntry(rate_NewLayer1_Iso_unpacked,"Di-#tau iso (Option 22), unpacked","L");
 ...
 //
  ...
  TH1F* ratioPlot22_mean = (TH1F*)rate_NewLayer1_Option31_extrap_mean->Clone("ratioPlot");
  ratioPlot22_mean->Divide(rate_NewLayer1_noIso_mean);
  // TH1F* ratioPlot22_mean = (TH1F*)rate_NewLayer1_noIso_mean->Clone("ratioPlot");
  // ratioPlot22_mean->Divide(rate_NewLayer1_Option31_extrap_mean);
  ratioPlot22_mean->SetLineColor(kGreen-5);
  ...
  TH1F* ratioPlot22_unpacked = (TH1F*)rate_NewLayer1_Iso_unpacked->Clone("ratioPlot");
  ratioPlot22_unpacked->Divide(rate_NewLayer1_noIso_unpacked);
 ...
 //  ratioPlot22_unpacked->Divide(rate_NewLayer1_Iso_unpacked);
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option23_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option25_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option26_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option27_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option28_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option29_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option30_mean->GetNbinsX() ; ++i)
    {
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option31_mean->GetNbinsX() ; ++i)
    {
