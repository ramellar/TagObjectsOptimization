...
void plotResolutions(int run, TString date, int vers, float calibThr = 1.7, TString fitOption="crystalball", Bool_t nTTRange = kFALSE)
{
    ...
    // TString InputFileName_data = "/data_CMS/cms/motta/Run3preparation/"+date+"_optimizationV"+version+"_calibThr"+intgr+"p"+decim+"/EphemeralZeroBias_2018D_Run"+run_str+"_reEmuTPs_CALIBRATED.root";
    ...
    // std::vector<float>         *in_l1tEmuRawEt = 0;
    ...
    // inTree_data->SetBranchAddress("L1Tau_IEt", &in_l1tEmuRawEt);
    ...
    //         // FILL PT RESPONSE - FULL INCLUSIVE
    //         pt_response_ptInclusive_data->Fill( in_L1Tau_CalibPt_data->at(iTau) / in_l1tEmuRawEt->at(iTau) );
    //     }
    // }
    // f_data.Close();
    ...
    c.SaveAs("plots/optimizationV"+version+"/split/response_ptBins_optimizationV"+version+"_calibThr"+intgr+"p"+decim+".png");
    ...
    c2.SaveAs("plots/optimizationV"+version+"/split/response_absEtaBins_optimizationV"+version+"_calibThr"+intgr+"p"+decim+".png");
    ...
    c4.SaveAs("plots/optimizationV"+version+"/split/response_plusEtaBins_optimizationV"+version+"_calibThr"+intgr+"p"+decim+".png");
    ...
    c5.SaveAs("plots/optimizationV"+version+"/split/response_minusEtaBins_optimizationV"+version+"_calibThr"+intgr+"p"+decim+".png");
    ...
    c3.SaveAs("plots/optimizationV"+version+"/pt_resolution_optimizationV"+version+"_calibThr"+intgr+"p"+decim+"_fctPt.png");
    ...
    c6.SaveAs("plots/optimizationV"+version+"/pt_resolution_optimizationV"+version+"_calibThr"+intgr+"p"+decim+"_fctEta.png");
    ...
    // c7.SaveAs("plots/optimizationV"+version+"/data/Run"+run_str+"comparison_pt_resolution_optimizationV"+version+"_calibThr"+intgr+"p"+decim+"_inclusivePtEta.png");
    ...
    c8.SaveAs("plots/optimizationV"+version+"/ptVSeta_resolution_optimizationV"+version+"_calibThr"+intgr+"p"+decim+".png");
}
