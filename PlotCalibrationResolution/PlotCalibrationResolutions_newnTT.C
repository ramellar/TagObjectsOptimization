...
void plotResolutions(TString fitOption="crystalball", Bool_t nTTRange = kFALSE)
{
    ...
    TH1F* pt_barrel_resp_ptBin20to30 = new TH1F("pt_barrel_resp_ptBin20to30","pt_barrel_resp_ptBin20to30",60,0,3);
    TH1F* pt_barrel_resp_ptBin30to40 = new TH1F("pt_barrel_resp_ptBin30to40","pt_barrel_resp_ptBin30to40",60,0,3);
    TH1F* pt_barrel_resp_ptBin40to60 = new TH1F("pt_barrel_resp_ptBin40to60","pt_barrel_resp_ptBin40to60",60,0,3);
    TH1F* pt_barrel_resp_ptBin60to100 = new TH1F("pt_barrel_resp_ptBin60to100","pt_barrel_resp_ptBin60to100",60,0,3);
    TH1F* pt_barrel_resp_ptBin100to200 = new TH1F("pt_barrel_resp_ptBin100to200","pt_barrel_resp_ptBin100to200",60,0,3);

    TH1F* pt_endcap_resp_ptInclusive = new TH1F("pt_endcap_resp_ptInclusive","pt_endcap_resp_ptInclusive",60,0,3);
    TH1F* pt_endcap_resp_ptBin20to30 = new TH1F("pt_endcap_resp_ptBin20to30","pt_endcap_resp_ptBin20to30",60,0,3);
    TH1F* pt_endcap_resp_ptBin30to40 = new TH1F("pt_endcap_resp_ptBin30to40","pt_endcap_resp_ptBin30to40",60,0,3);
    TH1F* pt_endcap_resp_ptBin40to60 = new TH1F("pt_endcap_resp_ptBin40to60","pt_endcap_resp_ptBin40to60",60,0,3);
    TH1F* pt_endcap_resp_ptBin60to100 = new TH1F("pt_endcap_resp_ptBin60to100","pt_endcap_resp_ptBin60to100",60,0,3);
    TH1F* pt_endcap_resp_ptBin100to200 = new TH1F("pt_endcap_resp_ptBin100to200","pt_endcap_resp_ptBin100to200",60,0,3);
    ...
    Double_t pt_bins[6] = {20,30,40,60,100,200};
    Double_t absEta_bins[5] = {0.,0.5,1.,1.5,2.1};
    Double_t eta_bins[9] = {-2.1,-1.5,-1.,-0.5,0.,0.5,1.,1.5,2.1};
    TH1F* pt_resol_barrel_fctPt = new TH1F("pt_resol_barrel_fctPt","pt_resol_barrel_fctPt",5, pt_bins);
    TH1F* pt_resol_endcap_fctPt = new TH1F("pt_resol_endcap_fctPt","pt_resol_endcap_fctPt",5, pt_bins);
    ...
    for(UInt_t i = 0 ; i < inTree->GetEntries() ; ++i)
    {
        ...
        if(in_OfflineTau_isMatched!=1) continue;
        ...
        if (fabs(in_OfflineTau_eta)<1.5)
        {
            ...
            if (in_OfflineTau_pt >= 20 and in_OfflineTau_pt < 30) pt_barrel_resp_ptBin20to30->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 30 and in_OfflineTau_pt < 40) pt_barrel_resp_ptBin30to40->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 40 and in_OfflineTau_pt < 60) pt_barrel_resp_ptBin40to60->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 60 and in_OfflineTau_pt < 100) pt_barrel_resp_ptBin60to100->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 100 and in_OfflineTau_pt <= 200) pt_barrel_resp_ptBin100to200->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
        }
        else
        {
            pt_endcap_resp_ptInclusive->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 20 and in_OfflineTau_pt < 30) pt_endcap_resp_ptBin20to30->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 30 and in_OfflineTau_pt < 40) pt_endcap_resp_ptBin30to40->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 40 and in_OfflineTau_pt < 60) pt_endcap_resp_ptBin40to60->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 60 and in_OfflineTau_pt < 100) pt_endcap_resp_ptBin60to100->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
            if (in_OfflineTau_pt >= 100 and in_OfflineTau_pt <= 200) pt_endcap_resp_ptBin100to200->Fill(in_L1Tau_CalibPt/in_OfflineTau_pt) ;
        }
    ...
    pt_barrel_resp_ptBin20to30->Scale(1.0/pt_barrel_resp_ptBin20to30->Integral());
    pt_barrel_resp_ptBin30to40->Scale(1.0/pt_barrel_resp_ptBin30to40->Integral());
    pt_barrel_resp_ptBin40to60->Scale(1.0/pt_barrel_resp_ptBin40to60->Integral());
    pt_barrel_resp_ptBin60to100->Scale(1.0/pt_barrel_resp_ptBin60to100->Integral());
    pt_barrel_resp_ptBin100to200->Scale(1.0/pt_barrel_resp_ptBin100to200->Integral());

    pt_endcap_resp_ptInclusive->Scale(1.0/pt_endcap_resp_ptInclusive->Integral());
    pt_endcap_resp_ptBin20to30->Scale(1.0/pt_endcap_resp_ptBin20to30->Integral());
    pt_endcap_resp_ptBin30to40->Scale(1.0/pt_endcap_resp_ptBin30to40->Integral());
    pt_endcap_resp_ptBin40to60->Scale(1.0/pt_endcap_resp_ptBin40to60->Integral());
    pt_endcap_resp_ptBin60to100->Scale(1.0/pt_endcap_resp_ptBin60to100->Integral());
    pt_endcap_resp_ptBin100to200->Scale(1.0/pt_endcap_resp_ptBin100to200->Integral());
    ...
    TF1 fit_barrel_Inclusive = fitResponseHisto(fitOption, pt_barrel_resp_ptInclusive, 0, 3, pt_barrel_resp_ptInclusive->Integral(), 1, 0.2, -0.9, 10);
    TF1 fit_barrel_Bin20to30 = fitResponseHisto(fitOption, pt_barrel_resp_ptBin20to30, 0, 3, pt_barrel_resp_ptBin20to30->Integral(), 1, 0.2, -0.9, 5);
    TF1 fit_barrel_Bin30to40 = fitResponseHisto(fitOption, pt_barrel_resp_ptBin30to40, 0, 3, pt_barrel_resp_ptBin30to40->Integral(), 1, 0.2, -0.7, 7);
    TF1 fit_barrel_Bin40to60 = fitResponseHisto(fitOption, pt_barrel_resp_ptBin40to60, 0, 3, pt_barrel_resp_ptBin40to60->Integral(), 1, 0.2, -1, 8);
    TF1 fit_barrel_Bin60to100 = fitResponseHisto(fitOption, pt_barrel_resp_ptBin60to100, 0, 3, pt_barrel_resp_ptBin60to100->Integral(), 1, 0.2, -1, 10);
    TF1 fit_barrel_Bin100to200 = fitResponseHisto(fitOption, pt_barrel_resp_ptBin100to200, 0, 3, pt_barrel_resp_ptBin100to200->Integral(), 1, 0.2, -1, 3);

    TF1 fit_endcap_Inclusive = fitResponseHisto(fitOption, pt_endcap_resp_ptInclusive, 0, 3, pt_endcap_resp_ptInclusive->Integral(), 1, 0.2, -0.9, 10);
    TF1 fit_endcap_Bin20to30 = fitResponseHisto(fitOption, pt_endcap_resp_ptBin20to30, 0, 3, pt_endcap_resp_ptBin20to30->Integral(), 1, 0.2, -1, 3);
    TF1 fit_endcap_Bin30to40 = fitResponseHisto(fitOption, pt_endcap_resp_ptBin30to40, 0, 3, pt_endcap_resp_ptBin30to40->Integral(), 1, 0.2, -0.8, 3);
    TF1 fit_endcap_Bin40to60 = fitResponseHisto(fitOption, pt_endcap_resp_ptBin40to60, 0, 3, pt_endcap_resp_ptBin40to60->Integral(), 1, 0.2, -1.5, 4);
    TF1 fit_endcap_Bin60to100 = fitResponseHisto(fitOption, pt_endcap_resp_ptBin60to100, 0, 3, pt_endcap_resp_ptBin60to100->Integral(), 1, 0.2, -1, 2);
    TF1 fit_endcap_Bin100to200 = fitResponseHisto(fitOption, pt_endcap_resp_ptBin100to200, 0, 3, pt_endcap_resp_ptBin100to200->Integral(), 1, 0.2, -1.5, 2);
    ...
    // pt_resol_barrel_fctPt->SetBinContent(1, fit_barrel_Bin20to30.GetParameter("Sigma"));
    // pt_resol_barrel_fctPt->SetBinError(1, fit_barrel_Bin20to30.GetParError(3));
    // pt_resol_barrel_fctPt->SetBinContent(2, fit_barrel_Bin30to40.GetParameter("Sigma"));
    // pt_resol_barrel_fctPt->SetBinError(2, fit_barrel_Bin30to40.GetParError(3));
    // pt_resol_barrel_fctPt->SetBinContent(3, fit_barrel_Bin40to60.GetParameter("Sigma"));
    // pt_resol_barrel_fctPt->SetBinError(3, fit_barrel_Bin40to60.GetParError(3));
    // pt_resol_barrel_fctPt->SetBinContent(4, fit_barrel_Bin60to100.GetParameter("Sigma"));
    // pt_resol_barrel_fctPt->SetBinError(4, fit_barrel_Bin60to100.GetParError(3));
    // pt_resol_barrel_fctPt->SetBinContent(5, fit_barrel_Bin100to200.GetParameter("Sigma"));
    // pt_resol_barrel_fctPt->SetBinError(5, fit_barrel_Bin100to200.GetParError(3));

    // pt_resol_endcap_fctPt->SetBinContent(1, fit_endcap_Bin20to30.GetParameter("Sigma"));
    // pt_resol_endcap_fctPt->SetBinError(1, fit_endcap_Bin20to30.GetParError(3));
    // pt_resol_endcap_fctPt->SetBinContent(2, fit_endcap_Bin30to40.GetParameter("Sigma"));
    // pt_resol_endcap_fctPt->SetBinError(2, fit_endcap_Bin30to40.GetParError(3));
    // pt_resol_endcap_fctPt->SetBinContent(3, fit_endcap_Bin40to60.GetParameter("Sigma"));
    // pt_resol_endcap_fctPt->SetBinError(3, fit_endcap_Bin40to60.GetParError(3));
    // pt_resol_endcap_fctPt->SetBinContent(4, fit_endcap_Bin60to100.GetParameter("Sigma"));
    // pt_resol_endcap_fctPt->SetBinError(4, fit_endcap_Bin60to100.GetParError(3));
    // pt_resol_endcap_fctPt->SetBinContent(5, fit_endcap_Bin100to200.GetParameter("Sigma"));
    // pt_resol_endcap_fctPt->SetBinError(5, fit_endcap_Bin100to200.GetParError(3));
    ...
    pt_resol_barrel_fctPt->SetBinContent(1, pt_barrel_resp_ptBin20to30->GetRMS());
    pt_resol_barrel_fctPt->SetBinError(1, pt_barrel_resp_ptBin20to30->GetRMSError());
    pt_resol_barrel_fctPt->SetBinContent(2, pt_barrel_resp_ptBin30to40->GetRMS());
    pt_resol_barrel_fctPt->SetBinError(2, pt_barrel_resp_ptBin30to40->GetRMSError());
    pt_resol_barrel_fctPt->SetBinContent(3, pt_barrel_resp_ptBin40to60->GetRMS());
    pt_resol_barrel_fctPt->SetBinError(3, pt_barrel_resp_ptBin40to60->GetRMSError());
    pt_resol_barrel_fctPt->SetBinContent(4, pt_barrel_resp_ptBin60to100->GetRMS());
    pt_resol_barrel_fctPt->SetBinError(4, pt_barrel_resp_ptBin60to100->GetRMSError());
    pt_resol_barrel_fctPt->SetBinContent(5, pt_barrel_resp_ptBin100to200->GetRMS());
    pt_resol_barrel_fctPt->SetBinError(5, pt_barrel_resp_ptBin100to200->GetRMSError());

    pt_resol_endcap_fctPt->SetBinContent(1, pt_endcap_resp_ptBin20to30->GetRMS());
    pt_resol_endcap_fctPt->SetBinError(1, pt_endcap_resp_ptBin20to30->GetRMSError());
    pt_resol_endcap_fctPt->SetBinContent(2, pt_endcap_resp_ptBin30to40->GetRMS());
    pt_resol_endcap_fctPt->SetBinError(2, pt_endcap_resp_ptBin30to40->GetRMSError());
    pt_resol_endcap_fctPt->SetBinContent(3, pt_endcap_resp_ptBin40to60->GetRMS());
    pt_resol_endcap_fctPt->SetBinError(3, pt_endcap_resp_ptBin40to60->GetRMSError());
    pt_resol_endcap_fctPt->SetBinContent(4, pt_endcap_resp_ptBin60to100->GetRMS());
    pt_resol_endcap_fctPt->SetBinError(4, pt_endcap_resp_ptBin60to100->GetRMSError());
    pt_resol_endcap_fctPt->SetBinContent(5, pt_endcap_resp_ptBin100to200->GetRMS());
    pt_resol_endcap_fctPt->SetBinError(5, pt_endcap_resp_ptBin100to200->GetRMSError());
    ...
    pt_resol_fctEta->SetBinContent(1, pt_resp_PlusEtaBin0to0p5->GetRMS());
    pt_resol_fctEta->SetBinError(1, pt_resp_PlusEtaBin0to0p5->GetRMSError());
    pt_resol_fctEta->SetBinContent(2, pt_resp_PlusEtaBin0p5to1->GetRMS());
    pt_resol_fctEta->SetBinError(2, pt_resp_PlusEtaBin0p5to1->GetRMSError());
    pt_resol_fctEta->SetBinContent(3, pt_resp_PlusEtaBin1to1p5->GetRMS());
    pt_resol_fctEta->SetBinError(3, pt_resp_PlusEtaBin1to1p5->GetRMSError());
    pt_resol_fctEta->SetBinContent(4, pt_resp_PlusEtaBin1p5to2p1->GetRMS());
    pt_resol_fctEta->SetBinError(4, pt_resp_PlusEtaBin1p5to2p1->GetRMSError());
    pt_resol_fctEta->SetBinContent(5, pt_resp_MinusEtaBin0to0p5->GetRMS());
    pt_resol_fctEta->SetBinError(5, pt_resp_MinusEtaBin0to0p5->GetRMSError());
    pt_resol_fctEta->SetBinContent(6, pt_resp_MinusEtaBin0p5to1->GetRMS());
    pt_resol_fctEta->SetBinError(6, pt_resp_MinusEtaBin0p5to1->GetRMSError());
    pt_resol_fctEta->SetBinContent(7, pt_resp_MinusEtaBin1to1p5->GetRMS());
    pt_resol_fctEta->SetBinError(7, pt_resp_MinusEtaBin1to1p5->GetRMSError());
    pt_resol_fctEta->SetBinContent(8, pt_resp_MinusEtaBin1p5to2p1->GetRMS());
    pt_resol_fctEta->SetBinError(8, pt_resp_MinusEtaBin1p5to2p1->GetRMSError());

    // SET HIST COLORS
    pt_barrel_resp_ptInclusive->SetLineColor(kRed);
    pt_barrel_resp_ptBin20to30->SetLineColor(kRed);
    pt_barrel_resp_ptBin30to40->SetLineColor(kRed);
    pt_barrel_resp_ptBin40to60->SetLineColor(kRed);
    pt_barrel_resp_ptBin60to100->SetLineColor(kRed);
    pt_barrel_resp_ptBin100to200->SetLineColor(kRed);

    pt_endcap_resp_ptInclusive->SetLineColor(kBlack);
    pt_endcap_resp_ptBin20to30->SetLineColor(kBlack);
    pt_endcap_resp_ptBin30to40->SetLineColor(kBlack);
    pt_endcap_resp_ptBin40to60->SetLineColor(kBlack);
    pt_endcap_resp_ptBin60to100->SetLineColor(kBlack);
    pt_endcap_resp_ptBin100to200->SetLineColor(kBlack);

    // SET HIST LINE WIDTH
    // pt_barrel_resp_ptInclusive->SetLineWidth(2);
    // pt_barrel_resp_ptBin20to30->SetLineWidth(2);
    // pt_barrel_resp_ptBin30to40->SetLineWidth(2);
    // pt_barrel_resp_ptBin40to60->SetLineWidth(2);
    // pt_barrel_resp_ptBin60to100->SetLineWidth(2);
    // pt_barrel_resp_ptBin100to200->SetLineWidth(2);

    // pt_endcap_resp_ptInclusive->SetLineWidth(2);
    // pt_endcap_resp_ptBin20to30->SetLineWidth(2);
    // pt_endcap_resp_ptBin30to40->SetLineWidth(2);
    // pt_endcap_resp_ptBin40to60->SetLineWidth(2);
    // pt_endcap_resp_ptBin60to100->SetLineWidth(2);
    // pt_endcap_resp_ptBin100to200->SetLineWidth(2);

    // pt_resp_AbsEtaBin0to0p5->SetLineWidth(2);
    // pt_resp_AbsEtaBin0p5to1->SetLineWidth(2);
    // pt_resp_AbsEtaBin1to1p5->SetLineWidth(2);
    // pt_resp_AbsEtaBin1p5to2p1->SetLineWidth(2);

    // pt_resp_PlusEtaBin0to0p5->SetLineWidth(2);
    // pt_resp_PlusEtaBin0p5to1->SetLineWidth(2);
    // pt_resp_PlusEtaBin1to1p5->SetLineWidth(2);
    // pt_resp_PlusEtaBin1p5to2p1->SetLineWidth(2);

    // pt_resp_MinusEtaBin0to0p5->SetLineWidth(2);
    // pt_resp_MinusEtaBin0p5to1->SetLineWidth(2);
    // pt_resp_MinusEtaBin1to1p5->SetLineWidth(2);
    // pt_resp_MinusEtaBin1p5to2p1->SetLineWidth(2);

    // SET HIST MARKERS
    pt_barrel_resp_ptInclusive->SetMarkerStyle(8);
    pt_barrel_resp_ptBin20to30->SetMarkerStyle(8);
    pt_barrel_resp_ptBin30to40->SetMarkerStyle(8);
    pt_barrel_resp_ptBin40to60->SetMarkerStyle(8);
    pt_barrel_resp_ptBin60to100->SetMarkerStyle(8);
    pt_barrel_resp_ptBin100to200->SetMarkerStyle(8);

    pt_endcap_resp_ptInclusive->SetMarkerStyle(8);
    pt_endcap_resp_ptBin20to30->SetMarkerStyle(8);
    pt_endcap_resp_ptBin30to40->SetMarkerStyle(8);
    pt_endcap_resp_ptBin40to60->SetMarkerStyle(8);
    pt_endcap_resp_ptBin60to100->SetMarkerStyle(8);
    pt_endcap_resp_ptBin100to200->SetMarkerStyle(8);
    ...
    pt_barrel_resp_ptBin20to30->SetMarkerColor(kRed);
    pt_barrel_resp_ptBin30to40->SetMarkerColor(kRed);
    pt_barrel_resp_ptBin40to60->SetMarkerColor(kRed);
    pt_barrel_resp_ptBin60to100->SetMarkerColor(kRed);
    pt_barrel_resp_ptBin100to200->SetMarkerColor(kRed);

    pt_endcap_resp_ptInclusive->SetMarkerColor(kBlack);
    pt_endcap_resp_ptBin20to30->SetMarkerColor(kBlack);
    pt_endcap_resp_ptBin30to40->SetMarkerColor(kBlack);
    pt_endcap_resp_ptBin40to60->SetMarkerColor(kBlack);
    pt_endcap_resp_ptBin60to100->SetMarkerColor(kBlack);
    pt_endcap_resp_ptBin100to200->SetMarkerColor(kBlack);
    ...
    fit_barrel_Bin20to30.SetLineColor(kRed);
    fit_barrel_Bin30to40.SetLineColor(kRed);
    fit_barrel_Bin40to60.SetLineColor(kRed);
    fit_barrel_Bin60to100.SetLineColor(kRed);
    fit_barrel_Bin100to200.SetLineColor(kRed);

    fit_endcap_Inclusive.SetLineColor(kBlack);
    fit_endcap_Bin20to30.SetLineColor(kBlack);
    fit_endcap_Bin30to40.SetLineColor(kBlack);
    fit_endcap_Bin40to60.SetLineColor(kBlack);
    fit_endcap_Bin60to100.SetLineColor(kBlack);
    fit_endcap_Bin100to200.SetLineColor(kBlack);
    ...
    pt_barrel_resp_ptBin20to30->SetTitle("");
    pt_barrel_resp_ptBin30to40->SetTitle("");
    pt_barrel_resp_ptBin40to60->SetTitle("");
    pt_barrel_resp_ptBin60to100->SetTitle("");
    pt_barrel_resp_ptBin100to200->SetTitle("");

    pt_endcap_resp_ptInclusive->SetTitle("");
    pt_endcap_resp_ptBin20to30->SetTitle("");
    pt_endcap_resp_ptBin30to40->SetTitle("");
    pt_endcap_resp_ptBin40to60->SetTitle("");
    pt_endcap_resp_ptBin60to100->SetTitle("");
    pt_endcap_resp_ptBin100to200->SetTitle("");
    ...
    TPaveText* texl = new TPaveText(0.2,0.87,0.6,0.99,"NDC");
    texl->AddText("CMS Internal, #sqrt{s}=13 TeV, Run3 MC VBFHToTauTau (M125)");
    ...
    leg->Clear();
    leg->AddEntry((TObject*)0, "20 < p_{T} < 30", "");
    leg->AddEntry(pt_barrel_resp_ptBin20to30,"Barrel |#eta|<1.5","L");
    leg->AddEntry(pt_endcap_resp_ptBin20to30,"Endcap 1.5<|#eta|<2.1","L");

    pt_barrel_resp_ptBin20to30->GetXaxis()->SetTitle("E_{T}^{L1}(#tau)/p_{T}^{offline}(#tau)");
    pt_barrel_resp_ptBin20to30->GetYaxis()->SetTitle("a.u");

    pt_barrel_resp_ptBin20to30->Draw("E0");
    pt_endcap_resp_ptBin20to30->Draw("E0 same");
    fit_barrel_Bin20to30.Draw("same");
    fit_endcap_Bin20to30.Draw("same");
    texl->Draw("same");
    leg->Draw("same");
    ...
    leg->Clear();
    leg->AddEntry((TObject*)0, "30 < p_{T} < 40", "");
    leg->AddEntry(pt_barrel_resp_ptBin30to40,"Barrel |#eta|<1.5","L");
    leg->AddEntry(pt_endcap_resp_ptBin30to40,"Endcap 1.5<|#eta|<2.1","L");

    pt_barrel_resp_ptBin30to40->GetXaxis()->SetTitle("E_{T}^{L1}(#tau)/p_{T}^{offline}(#tau)");
    pt_barrel_resp_ptBin30to40->GetYaxis()->SetTitle("a.u");

    pt_barrel_resp_ptBin30to40->Draw("E0");
    pt_endcap_resp_ptBin30to40->Draw("E0 same");
    fit_barrel_Bin30to40.Draw("same");
    fit_endcap_Bin30to40.Draw("same");
    texl->Draw("same");
    leg->Draw("same");
    ...
    leg->Clear();
    leg->AddEntry((TObject*)0, "40 < p_{T} < 60", "");
    leg->AddEntry(pt_barrel_resp_ptBin40to60,"Barrel |#eta|<1.5","L");
    leg->AddEntry(pt_endcap_resp_ptBin40to60,"Endcap 1.5<|#eta|<2.1","L");

    pt_barrel_resp_ptBin40to60->GetXaxis()->SetTitle("E_{T}^{L1}(#tau)/p_{T}^{offline}(#tau)");
    pt_barrel_resp_ptBin40to60->GetYaxis()->SetTitle("a.u");

    pt_barrel_resp_ptBin40to60->Draw("E0");
    pt_endcap_resp_ptBin40to60->Draw("E0 same");
    fit_barrel_Bin40to60.Draw("same");
    fit_endcap_Bin40to60.Draw("same");
    texl->Draw("same");
    leg->Draw("same");
    ...
    leg->Clear();
    leg->AddEntry((TObject*)0, "60 < p_{T} < 100", "");
    leg->AddEntry(pt_barrel_resp_ptBin60to100,"Barrel |#eta|<1.5","L");
    leg->AddEntry(pt_endcap_resp_ptBin60to100,"Endcap 1.5<|#eta|<2.1","L");

    pt_barrel_resp_ptBin60to100->GetXaxis()->SetTitle("E_{T}^{L1}(#tau)/p_{T}^{offline}(#tau)");
    pt_barrel_resp_ptBin60to100->GetYaxis()->SetTitle("a.u");

    pt_barrel_resp_ptBin60to100->Draw("E0");
    pt_endcap_resp_ptBin60to100->Draw("E0 same");
    fit_barrel_Bin60to100.Draw("same");
    fit_endcap_Bin60to100.Draw("same");
    texl->Draw("same");
    leg->Draw("same");
    ...
    leg->Clear();
    leg->AddEntry((TObject*)0, "100 < p_{T} < 200", "");
    leg->AddEntry(pt_barrel_resp_ptBin100to200,"Barrel |#eta|<1.5","L");
    leg->AddEntry(pt_endcap_resp_ptBin100to200,"Endcap 1.5<|#eta|<2.1","L");

    pt_barrel_resp_ptBin100to200->GetXaxis()->SetTitle("E_{T}^{L1}(#tau)/p_{T}^{offline}(#tau)");
    pt_barrel_resp_ptBin100to200->GetYaxis()->SetTitle("a.u");

    pt_barrel_resp_ptBin100to200->Draw("E0");
    pt_endcap_resp_ptBin100to200->Draw("E0 same");
    fit_barrel_Bin100to200.Draw("same");
    fit_endcap_Bin100to200.Draw("same");
    texl->Draw("same");
    leg->Draw("same");
    ...
    c.SaveAs("response_ptBins_"+fitOption+".png");
    ...
    c2.SaveAs("response_absEtaBins_"+fitOption+".png");
    ...
    c4.SaveAs("response_plusEtaBins_"+fitOption+".png");
    ...
    c5.SaveAs("response_minusEtaBins_"+fitOption+".png");

    //##########
    // plot resolution in pt and eta bins

    TCanvas c3("c3","c3",3000,800);
    c3.SetLeftMargin(0.15);
    c3.SetGrid();
    c3.cd();

    TPad *pad11 = new TPad("pad11", "pad11", 0., 0., 0.33, 1.);
    ...
    c3.cd();
    TPad *pad12 = new TPad("pad12", "pad12", 0.33, 0., 0.66, 1.);
    ...
    c3.cd();
    TPad *pad13 = new TPad("pad13", "pad13", 0.66, 0., 1., 1.);
    ...
    c3.SaveAs("pt_resolution_"+fitOption+".png");
}
