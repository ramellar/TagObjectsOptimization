...
# sh produce_plots.sh 2024W-MC_caloParams_2023_JAX_ECAL_19_HCAL_51_Phys_newCalib_data_validation Muon_Run2023D-PromptReco-v1_MINIAOD.root

working_dir='/data_CMS/cms/mchiusi/Run3preparation/Run3_2024/2024W-MC_caloParams_2023_JAX_ECAL_19_HCAL_51_Phys_newCalib/data_validation/'
pwd=$(pwd)
