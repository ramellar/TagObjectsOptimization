...
void ApplyIsolationForTurnOns(TString tag, int run)
{
  ...
  if(run==356375)
  {
    // Threshold_NewLayer1_noIso = 38.51; // unpacked
    // Threshold_NewLayer1_Iso = 27.51; // unpacked

    Threshold_NewLayer1_noIso = 39.51; // re-emulated
    Threshold_NewLayer1_Iso = 29.51; // re-emulated
  }
  else if(run==356378)
  {
    // Threshold_NewLayer1_noIso = 39.51; // unpacked
    // Threshold_NewLayer1_Iso = 28.51; // unpacked

    Threshold_NewLayer1_noIso = 40.51; // re-emulated
    Threshold_NewLayer1_Iso = 30.51; // re-emulated
  }
  else if(run==356381)
  {
    // Threshold_NewLayer1_noIso = 39.51; // unpacked
  ...
  {
    std::cout << "** ERROR: PROBLEM IN THE INITIALIZATION OF THE THRESHOLDS - EXITING!" << std::endl;
    return;
  }
