...
ApplyCalibrationZeroBias("${working_dir}${2}.root", "/data_CMS/cms/amella/Run3_2025/${2}_${1}_CALIBRATED.root", \
                         "corrections_2025/corrections_BDT_training_HCALcFeb-caloParams_2025_conservative-ZS-MC25W_corrected.root")
.q
EOF
...
# echo "Making LUT with 0.7,16,31"

# cd ${pwd}/Isolate/

# root -l -b <<EOF
# .L MakeTauIsoLUT.C+
# MakeTauIsoLUT_Options("ROOTs4LUTs_2025/LUTrelaxation_${1}.root","LUTs/LUTs_2025/NewLUTrelaxation_${1}.txt", 0.7, 16, 31)
# .q
# EOF
