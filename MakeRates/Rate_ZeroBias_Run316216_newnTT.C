...
#include <fstream>
#include "../ApplyCalibration/ApplyCalibration_newnTT.C"
#include <map>
...
void Rate()
{
  ...
  */
  ...
  TFile f_Isolation("/data_CMS/cms/davignon/TauTagAndProbe_92X_for2018_May2018/CMSSW_9_2_8/src/TauTagAndProbe/TauTagAndProbe/test/Optimization/ApplyRelaxation/Iso_LUTs_Options_MC_92X_v1_1_newLayer1_newLayer2_newnTT.root","READ");
  ...
  TString FileName_in = "../ApplyCalibration/calibratedOutput_Ntuple_ZeroBias_Run316216_newLayer1_newLayer2_newnTT.root";
  // TString FileName_in = "calibratedOutput_Ntuple_ZeroBias_L1_29_03_17_WithMarch2017Layer1_ShapeVeto.root";
  // TString FileName_in = "calibratedOutput_Ntuple_ZeroBias_L1_07_02_17_With2017Layer1.root";
  ...
  //in the case of DoubleJet_XX_YY_Mass_ZZ_Mu_WW
  //TH4F* ptjet1_ptjet2_jetmass_ptmu;
  ...
  */ 
  ...
  for(UInt_t i = 0 ; i < inTree->GetEntries() ; ++i)
      ...
      if(Index_Taus_IsoInf.at(0)>=0 && Index_Taus_IsoInf.at(1)>=0)
	{
	  ...
	  //ptjet1_ptjet2_jetmass_ptmu->Fill(pt
  ...
  for(UInt_t i = 0 ; i < 241 ; ++i)
    {
      ...
      //rate_4D->SetBinContent(i+1, j+1, k+1, l+1, ptjet1_ptj2...->Integral(i+1,ptjet1_ptj2->GetNbinsX()+1,j...../Denominator*scale);
      //XX = 5 GeV steps from 0 to 100
      //YY = 5 GeV steps from 0 to 100
      //ZZ = 25 GeV steps from 200 to 1000
      //WW = 1 GeV steps from 3 to 15
  ...
  TFile f("histos_rate_Run316216_v1_1_newLayer1_newLayer2_newnTT.root","RECREATE");
  ...
  //find the combination of cuts that give ~ 1 kHz
  for(UInt_t i = 0 ; i < rate_4D->GetNbins() ; ++i)
    {
      if(rate_4D->GetBinContent(i)<1.05 && rate_4D->GetBinContent(i)>0.95) cout<<"this combination of XX, YY, ZZ, WW = "<<dsflksf<<"produces a rate of "<<rate_4D->GetBinContent(i)<<endl;
    }
