...
void Rate(TString parametrisation = "linear", Double_t Kfact = 0.0, TString nuGlobalTag = "122X", bool Run3reweight = false, float calibThr = 1.7)
{
  /*
  ...
  */
  ...
  TString FileName_in = "/data_CMS/cms/motta/Run3preparation/2022_06_13_optimizationV13_calibThr"+intgr+"p"+decim+"/Run3_MC_SingleNeutrinoGun"+nuGlobalTag+"_CALIBRATED_2022_06_13.root";
  ...
  inTree->SetBranchAddress("Run3RateWeight", &in_Run3RateWeight);
      ...
      for(UInt_t iL1Tau = 0 ; iL1Tau < in_CalibPt->size() ; ++iL1Tau)
        {
          ...
          if(Run3reweight) weight = in_Run3RateWeight;
          ...
          if(!Filled_Progression_1 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_1)
            {
              pt_Progression_1->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_2 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_2)
            {
              pt_Progression_2->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_3 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_3)
            {
              pt_Progression_3->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_4 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_4)
            {
              pt_Progression_4->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_5 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_5)
            {
              pt_Progression_5->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_6 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_6)
            {
              pt_Progression_6->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_7 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_7)
            {
              pt_Progression_7->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_8 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_8)
            {
              pt_Progression_8->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_9 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_9)
            {
              pt_Progression_9->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_10 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_10)
            {
              pt_Progression_10->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_11 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_11)
            {
              pt_Progression_11->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_12 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_12)
            {
              pt_Progression_12->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_13 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_13)
            {
              pt_Progression_13->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_14 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_14)
            {
              pt_Progression_14->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_15 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_15)
            {
              pt_Progression_15->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_16 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_16)
            {
              pt_Progression_16->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_17 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_17)
            {
              pt_Progression_17->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_18 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_18)
            {
              pt_Progression_18->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_19 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_19)
            {
              pt_Progression_19->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_20 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_20)
            {
              pt_Progression_20->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_21 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_21)
            {
              pt_Progression_21->Fill(in_CalibPt->at(iL1Tau),weight);
          ...
          if(!Filled_Progression_22 && in_l1tEmuIsoEt->at(iL1Tau)<=IsoCut_Progression_22)
            {
              pt_Progression_22->Fill(in_CalibPt->at(iL1Tau),weight);
  ...
  // no luminosity rescaling needs to be taken into account fro NuGun
  ...
  TString TFileName = "";
  if(parametrisation=="linear") TFileName = "histos/histos_rate_SingleNeutrino"+nuGlobalTag+isPUReweighted+"_Run3_MC_optimizationV13_calibThr"+intgr+"p"+decim+"_linear.root";
  else                          TFileName = "histos/histos_rate_SingleNeutrino"+nuGlobalTag+isPUReweighted+"_Run3_MC_optimizationV13_calibThr"+intgr+"p"+decim+"_"+parametrisation+Kintgr+"p"+Kdecim+".root";
