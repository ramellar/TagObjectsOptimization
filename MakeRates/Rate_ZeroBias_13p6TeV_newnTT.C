...
void Rate(int run, TString parametrisation = "linear", Double_t Kfact = 0.0, float calibThr = 1.7)
{
  ...
  */
  ...
  TString FileName_in = "/data_CMS/cms/motta/Run3preparation/ZeroBias_Run2022C_Run"+run_str+"_RAW_reEmuTPs/ZeroBias_Run2022C_Run"+run_str+"_RAW_reEmuTPs_CALIBRATED.root";
