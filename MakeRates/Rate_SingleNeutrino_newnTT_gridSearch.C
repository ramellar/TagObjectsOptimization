...
void Rate(TString tag, TString parametrisation = "linear", Double_t Kfact = 0.0, TString nuGlobalTag = "122X", bool Run3reweight = false, float calibThr = 1.7)
{
    ...
    TString fIsoName = "";
    if(parametrisation=="linear") fIsoName = "/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/Isolate/ROOTs4LUTs/LUTrelaxation_Trigger_Stage2_Run3_MC_VBFHToTauTau_M125_optimizationV13gs_calibThr"+intgr+"p"+decim+"_linear_"+tag+".root";
    else                          fIsoName = "/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/Isolate/ROOTs4LUTs/LUTrelaxation_Trigger_Stage2_Run3_MC_VBFHToTauTau_M125_optimizationV13gs_calibThr"+intgr+"p"+decim+"_"+parametrisation+Kintgr+"p"+Kdecim+"_"+tag+".root";
    ...
    inTree->SetBranchAddress("TruePU", &in_TruePU);
    ...
    TString TFileName = "";
    if(parametrisation=="linear") TFileName = "histos/histos_rate_SingleNeutrino"+nuGlobalTag+isPUReweighted+"_Run3_MC_optimizationV13gs_calibThr"+intgr+"p"+decim+"_linear_"+tag+".root";
    else                          TFileName = "histos/histos_rate_SingleNeutrino"+nuGlobalTag+isPUReweighted+"_Run3_MC_optimizationV13gs_calibThr"+intgr+"p"+decim+"_"+parametrisation+Kintgr+"p"+Kdecim+"_"+tag+".root";
