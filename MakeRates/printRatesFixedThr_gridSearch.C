...
void compare(int run, TString tag, TString opt="0", TString baseline="22", float calibThr = 1.7) {
    ...
    float fm_noIso = ((TVectorT<float>*)f->Get("fm_noIso"))->Max();
    ...
    float fm_OptionA = ((TVectorT<float>*)f->Get("fm_OptionA"))->Max();
    float fm_OptionB = ((TVectorT<float>*)f->Get("fm_OptionB"))->Max();
    float fm_OptionC = ((TVectorT<float>*)f->Get("fm_OptionC"))->Max();
    float fm_OptionD = ((TVectorT<float>*)f->Get("fm_OptionD"))->Max();
    float fm_OptionE = ((TVectorT<float>*)f->Get("fm_OptionE"))->Max();
    float fm_OptionF = ((TVectorT<float>*)f->Get("fm_OptionF"))->Max();
    float fm_OptionG = ((TVectorT<float>*)f->Get("fm_OptionG"))->Max();
    float fm_OptionH = ((TVectorT<float>*)f->Get("fm_OptionH"))->Max();
    float fm_OptionI = ((TVectorT<float>*)f->Get("fm_OptionI"))->Max();
    float fm_OptionJ = ((TVectorT<float>*)f->Get("fm_OptionJ"))->Max();
    float fm_OptionK = ((TVectorT<float>*)f->Get("fm_OptionK"))->Max();
    float fm_OptionL = ((TVectorT<float>*)f->Get("fm_OptionL"))->Max();
    float fm_OptionM = ((TVectorT<float>*)f->Get("fm_OptionM"))->Max();
    float fm_OptionN = ((TVectorT<float>*)f->Get("fm_OptionN"))->Max();
    float fm_OptionO = ((TVectorT<float>*)f->Get("fm_OptionO"))->Max();
    float fm_OptionP = ((TVectorT<float>*)f->Get("fm_OptionP"))->Max();
    float fm_OptionQ = ((TVectorT<float>*)f->Get("fm_OptionQ"))->Max();
    float fm_OptionR = ((TVectorT<float>*)f->Get("fm_OptionR"))->Max();
    float fm_OptionS = ((TVectorT<float>*)f->Get("fm_OptionS"))->Max();
    float fm_OptionT = ((TVectorT<float>*)f->Get("fm_OptionT"))->Max();
    float fm_OptionU = ((TVectorT<float>*)f->Get("fm_OptionU"))->Max();
    float fm_OptionV = ((TVectorT<float>*)f->Get("fm_OptionV"))->Max();
    float fm_OptionW = ((TVectorT<float>*)f->Get("fm_OptionW"))->Max();
    float fm_OptionX = ((TVectorT<float>*)f->Get("fm_OptionX"))->Max();
    float fm_OptionY = ((TVectorT<float>*)f->Get("fm_OptionY"))->Max();
    float fm_OptionZ = ((TVectorT<float>*)f->Get("fm_OptionZ"))->Max();
