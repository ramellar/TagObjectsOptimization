...
if __name__ == "__main__" :
    ...
    if options.obj == "tau":
        ...
        inFile = ROOT.TFile('./EG/BtoG/HistogramFile_EffVsNvtx_'+options.tag+'.root')
    else:
    ...
    if options.obj == "tau":
        ...
        ## VERSUS NUMBER OF VERTICES
        eff_TGraph = inFile.Get('EG'+thr_str+'/Efficiency_vs_Nvtx_EG'+thr_str)
        eff_Iso_TGraph = inFile.Get('TightIsoEG'+thr_str+'/Efficiency_vs_Nvtx_TightIsoEG'+thr_str)
