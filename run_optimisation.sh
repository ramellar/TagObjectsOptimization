#!/usr/bin/bash
# ./run_optimisation.sh 2023S-MC_caloParams_2023_v0_4_data_validation Muon_Run2023D-PromptReco-v1_MINIAOD.root
...
compare("histos_2024/histos_rate_ZeroBias_Run${3}_${1}_unpacked.root", \
        "histos_2024/histos_rate_ZeroBias_Run${3}_${1}_optimisation.root", \
        "histos_2024/thresholds_fixedrate_ZeroBias_Run${3}_${1}unpacked_optimization.root")
.q
EOF
...
compare("${working_dir}Tau_MC_TURNONS_FIXEDRATE_14kHz_${1}", \
        "histos_2024/thresholds_fixedrate_ZeroBias_Run${3}_${1}unpacked_optimization.root", \
        "histos_2024/histos_rate_ZeroBias_Run${3}_${1}_unpacked.root", \
        "FMs/FMs_2024/FM_orderd_turnons_FIXEDRATE_14kHz_Run${3}_${1}")
.q
EOF

echo "Finish -- All good, best turnOns in CompareGridSearchTrunons/FMs/FMs_2024/FM_orderd_turnons_FIXEDRATE_14kHz_Run$3_$1.root"
