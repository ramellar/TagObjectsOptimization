...
from GBRmultiTraining2LUTEmulator import GBRmultiTraining2LUTEmulator

version = "V10_multiTrainingTest"
version0 = "V10_0compressedE6"
version1 = "V10_7compressedE31"

inputFile = "forests/GBRFullLikelihood_Trigger_Stage2_Run3_MC_VBFHToTauTau_M125_compressedieta_compressediet_hasEM_isMerged_optimization{0}_results.root forests/GBRFullLikelihood_Trigger_Stage2_Run3_MC_VBFHToTauTau_M125_compressedieta_compressediet_hasEM_isMerged_optimization{1}_results.root".format(version0, version1)
...
gbr2luts.append(GBRmultiTraining2LUTEmulator(2, 6))
gbr2luts[-1].name = "GBRFullLikelihood_Trigger_Stage2_Run3_MC_VBFHToTauTau_M125_compressedieta_compressediet_hasEM_isMerged_optimization{}".format(version)
gbr2luts[-1].inputFileName = inputFile
gbr2luts[-1].outputFileName = "corrections/corrections_Trigger_Stage2_Run3_MC_VBFHToTauTau_M125_compressedieta_compressediet_hasEM_isMerged_optimization{}.root".format(version)
