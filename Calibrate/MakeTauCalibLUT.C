...
void MakeTauCalibLUT(TString outFile, TString corrections, float calibThr = 1.7, Bool_t withLayer1 = kTRUE)
{
  ...
  TFile* fLUTS ;
  fLUTS = new TFile (corrections);

  TH3F* LUT_isMerged0 ;
  TH3F* LUT_isMerged1 ;//calibration constant is a number c(compressedieta, compressediet, hasEM, isMerged)
  LUT_isMerged0 = (TH3F*) fLUTS->Get ("LUT_isMerged0_GBRFullLikelihood_RAW_124X_results");
  LUT_isMerged1 = (TH3F*) fLUTS->Get ("LUT_isMerged1_GBRFullLikelihood_RAW_124X_results");
  ...
  // TString outFile ;
  // outFile = "/home/llr/cms/mchiusi/Run3preparation/Run3preparation_2023/CMSSW_11_0_2/src/TauObjectsOptimization/Calibrate/LUTs_2024/LUTcalibration_2023Summer_caloParams_2023_v0_4.txt";
