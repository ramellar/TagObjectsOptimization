...
void ApplyCalibrationSingleNeutrino(TString nuGlobalTag, float calibThr = 1.7)
// void ApplyCalibrationZeroBias(TString InputFileName = "Ntuple_ZeroBias_With2017Layer1_ShapeVeto_20_02_17.root")
{
    ...
    TString InputFileName  = "/data_CMS/cms/motta/Run3preparation/2022_06_13_optimizationV13_calibThr"+intgr+"p"+decim+"/Run3_MC_SingleNeutrinoGun_RAW"+nuGlobalTag+"_2022_06_13/Run3_MC_SingleNeutrinoGun_RAW"+nuGlobalTag+"_2022_06_13.root";
    TString OutputFileName = "/data_CMS/cms/motta/Run3preparation/2022_06_13_optimizationV13_calibThr"+intgr+"p"+decim+"/Run3_MC_SingleNeutrinoGun"+nuGlobalTag+"_CALIBRATED_2022_06_13.root";
    ...
    TTree* inTree = (TTree*)f_in.Get("Run3nuMC/ZeroBias");
    ...
    inTree->SetBranchAddress("TruePU", &TruePU, &b_TruePU);
    inTree->SetBranchAddress("Run3RateWeight", &Run3RateWeight, &b_Run3RateWeight);
    ...
    */
    ...
    outTree.Branch("TruePU", &out_TruePU, "TruePU/I");
    outTree.Branch("Run3RateWeight", &out_Run3RateWeight, "Run3RateWeight/F");
    ...
    //for(UInt_t i = 0 ; i < 100000 ; ++i)
    {
        ...
        for(UInt_t iL1Tau = 0 ; iL1Tau < l1tEmuPt->size() ; ++iL1Tau)
        {
            ...
            out_lumi = lumi;
            out_TruePU = TruePU;
            out_Run3RateWeight = Run3RateWeight;
