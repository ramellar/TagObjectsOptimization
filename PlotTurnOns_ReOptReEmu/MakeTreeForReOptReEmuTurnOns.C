...
void MatchOnlineAndOffline(int targetRate = 14)

{
  TString fixedRate = to_string(targetRate);

  TString InputFileName  = "/data_CMS/cms/motta/Run3preparation/2022_04_21_optimizationV11_ReOptReEmu/Run3_MC_VBFHToTauTau_M125_MERGED_ReOptReEmu"+fixedRate+"kHz_2022_04_21.root";
  TString OutputFileName  = "/data_CMS/cms/motta/Run3preparation/2022_04_21_optimizationV11_ReOptReEmu/Run3_MC_VBFHToTauTau_M125_MATCHED_ReOptReEmu"+fixedRate+"kHz_2022_04_21.root";
  ...
  TTree outTree("outTreeForTurnOns","outTreeForTurnOns");  
