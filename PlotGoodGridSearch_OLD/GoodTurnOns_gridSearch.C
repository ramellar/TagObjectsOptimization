...
void compare(int run, TString tag, TString opt="0", TString baseline="22", int fixedThr = 0, float calibThr = 1.7) {
    ...
    TFile* f;
    if (fixedThr==0) f = new TFile("/data_CMS/cms/motta/Run3preparation/2022_02_02_optimizationV7_calibThr"+intgr+"p"+decim+"/Run3_MC_VBFHToTauTau_M125_TURNONS_FIXEDRATE_Run"+run_str+"_gs_"+tag+"_"+opt+"_2022_02_02.root", "READ");
    else             f = new TFile("/data_CMS/cms/motta/Run3preparation/2022_02_02_optimizationV7_calibThr"+intgr+"p"+decim+"/Run3_MC_VBFHToTauTau_M125_TURNONS_FIXEDTHR"+fixedThreshold+"_Run"+run_str+"_gs_"+tag+"_"+opt+"_2022_02_02.root", "READ");
    ...
    TFile* f_mean = new TFile("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_ZeroBias_Run"+run_str+"_optimizationV7gs_calibThr"+intgr+"p"+decim+"_"+tag+".root","READ");
    TFile* f_unpacked = new TFile("/home/llr/cms/motta/Run3preparation/CMSSW_11_0_2/src/TauObjectsOptimization/MakeRates/histos/histos_rate_ZeroBias_Run"+run_str+"_optimizationV7_calibThr"+intgr+"p"+decim+"_unpacked.root","READ");  
    ...
    TString CanvasName = "Comparison_TurnOn_Run"+run_str+"_newnTT_unpacked_optimizationV7gs";
