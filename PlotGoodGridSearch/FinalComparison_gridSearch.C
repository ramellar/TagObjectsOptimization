...
void compare(int run, bool zoom=false, float calibThr = 1.7) {
    ...
    for (long unsigned int i = 0; i < points.size(); ++i)
    {
        ...
        TFile* f = new TFile("/data_CMS/cms/motta/Run3preparation/2022_01_28_optimizationV6_calibThr"+intgr+"p"+decim+"/Run3_MC_VBFHToTauTau_M125_TURNONS_FIXEDRATE_Run"+run_str+"_gs_"+tag+"_"+num+"_2022_01_28.root","READ");
    ...
    TString _tag = "";
    if (zoom) _tag = "_zoom";
    c.SaveAs("plotsFinalComparison_Run"+run_str+"/Comparison_visualSelection_proposal_optimizationV6_eq34"+_tag+".pdf");
