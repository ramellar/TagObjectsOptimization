...
void compare(int run, bool zoom=false, float calibThr = 1.7) {
    ...
    TFile* f = new TFile("/data_CMS/cms/motta/Run3preparation/2022_01_21_optimizationV4_calibThr"+intgr+"p"+decim+"/Run3_MC_VBFHToTauTau_M125_TURNONS_FIXEDRATE_Run"+run_str+"_gs_effMin0p0_0_2022_01_21.root","READ");
    ...
    for (long unsigned int i = 0; i < points.size(); ++i)
    {
        ...
        TFile* f = new TFile("/data_CMS/cms/motta/Run3preparation/2022_01_21_optimizationV4_calibThr"+intgr+"p"+decim+"/Run3_MC_VBFHToTauTau_M125_TURNONS_FIXEDRATE_Run"+run_str+"_gs_"+tag+"_"+num+"_2022_01_21.root","READ");
    ...
    TString _tag = "";
    if (zoom) _tag = "_zoom";
    //c.SaveAs("plotsFinalComparison_Run"+run_str+"/Comparison_visualSelection_proposal"+_tag+".pdf");
